...
import { CreateLiabilityDto, UpdateLiabilityDto } from './liabilities.dto';
...
export class LiabilitiesController {
  ...
  @Post() create(@Request() req: any, @Body() dto: CreateLiabilityDto) { return this.service.create(req.user.userId, dto); }
  ...
  @Patch(':id') update(@Request() req: any, @Param('id') id: string, @Body() dto: UpdateLiabilityDto) { return this.service.update(id, req.user.userId, dto); }
