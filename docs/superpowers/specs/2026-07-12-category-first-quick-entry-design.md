...
- 只显示当前交易类型可用的分类。
- 优先按最近 90 天交易次数排序，最多展示 7 个分类，第 8 个固定为“更多”。
- 没有历史数据时，按当前分类配置顺序展示。
...
- `FrequentCategoryGrid`：常用分类排序、选中和“更多”。
...
纯逻辑应从 UI 中分离：常用分类排序、金额表达式计算、默认值恢复和成功反馈文案分别提供可测试函数。
