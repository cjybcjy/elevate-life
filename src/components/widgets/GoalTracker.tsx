...
export default function GoalTracker({ goals }: { goals: Goal[] }) {
  ...
  return (
    <div className="bg-ledger-surface rounded-xl p-4">
      <h2 className="text-base font-bold text-white mb-3">储蓄目标</h2>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0 text-xs space-y-0.5">
                  <div className="flex justify-between">
                    ...
                    <AmountDisplay amount={current} className="text-white" />
                  </div>
                  <div className="flex justify-between">
                  ...
                  {daysLeft !== null && (
                    <div className="flex justify-between">
                      ...
                      <span className={daysLeft < 30 ? 'text-ledger-danger' : 'text-white'}>
                        {daysLeft} 天
                      </span>
                    </div>
                  )}
