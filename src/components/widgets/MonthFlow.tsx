...
export default function MonthFlow({
  ...
  return (
    <div className="bg-ledger-surface rounded-xl p-4">
      <h2 className="text-base font-bold text-white mb-3">本月流水</h2>
      ...
      <div className="flex items-center gap-4 text-sm mb-3">
        ...
        <span className="text-ledger-muted/30">|</span>
        <span className="text-ledger-muted">盈余率 <span className="text-white font-medium">{surplus}%</span></span>
      </div>
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1">
          <button
            ...
            className="w-full text-left text-sm text-white hover:text-ledger-accent mb-2 pb-1 border-b border-ledger-primary/10"
          >
