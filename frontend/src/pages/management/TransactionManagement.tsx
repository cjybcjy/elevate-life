...
export default function TransactionManagement() {
  ...
  const loadData = () => {
    setLoading(true);
    Promise.all([
      api.get('/transactions').then((res: any) => setTransactions(res.data?.data || [])),
      api.get('/categories').then((res: any) => setCategories(res.data?.data || [])),
      api.get('/assets').then((res: any) => setAssets(res.data?.data || [])),
